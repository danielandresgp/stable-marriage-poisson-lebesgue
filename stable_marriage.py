...
Jupyter-friendly script with smart user input + dynamic titles.

References:
- Hoffman, Holroyd, Peres (Ann. Probab. 2006)
- Hoffman, Holroyd, Peres (arXiv:0909.5325 & 0911.1429)
"""
...
STRIPE_WIDTH:
    ...
    STRIPE_WIDTH = 0.12   # Not used, but avoids potential errors
...
if USE_STRIPED_TERRITORIES:
    # Golden ratio for better color separation between neighboring territories
